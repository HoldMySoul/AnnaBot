...
import AnnaBot.modules.sql.feds_sql as sql
from AnnaBot import (
    EVENT_LOGS,
    LOGGER,
    SUPPORT_CHAT,
...
from AnnaBot.modules.helper_funcs.alternate import send_message
...
from AnnaBot.modules.helper_funcs.string_handling import markdown_parser
...
def fed_ban(update: Update, context: CallbackContext):
    ...
    if fban:
        fed_name = info["fname"]
        # https://t.me/AnnaBotSupport/41606 // https://t.me/AnnaBotSupport/41619
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "AnnaBot_fbanned_users.json"
                update.effective_message.reply_document(
                    document=output,
                    filename="AnnaBot_fbanned_users.json",
            ...
            for users in getfban:
                ...
                backups += "\n"
            with BytesIO(str.encode(backups)) as output:
                output.name = "AnnaBot_fbanned_users.csv"
                update.effective_message.reply_document(
                    document=output,
                    filename="AnnaBot_fbanned_users.csv",
