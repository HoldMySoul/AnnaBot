...
import AnnaBot.modules.sql.global_bans_sql as gban_sql
import AnnaBot.modules.sql.users_sql as user_sql
from AnnaBot import DEV_USERS, OWNER_ID, dispatcher
