...
import AnnaBot.modules.sql.notes_sql as sql
from AnnaBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from AnnaBot.__main__ import DATA_IMPORT
from AnnaBot.modules.helper_funcs.chat_status import user_admin
from AnnaBot.modules.helper_funcs.alternate import typing_action

# from AnnaBot.modules.rules import get_rules
import AnnaBot.modules.sql.rules_sql as rulessql

# from AnnaBot.modules.sql import warns_sql as warnssql
import AnnaBot.modules.sql.blacklist_sql as blacklistsql
from AnnaBot.modules.sql import disable_sql as disabledsql

# from AnnaBot.modules.sql import cust_filters_sql as filtersql
# import AnnaBot.modules.sql.welcome_sql as welcsql
import AnnaBot.modules.sql.locks_sql as locksql
from AnnaBot.modules.connection import connected
...
def export_data(update: Update, context: CallbackContext):
    ...
    with open("AnnaBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("AnnaBot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `AnnaBot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("AnnaBot{}.backup".format(chat_id))  # Cleaning file
