...
import telegram
from AnnaBot import WOLVES, dispatcher
from AnnaBot.modules.disable import DisableAbleCommandHandler
from AnnaBot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from AnnaBot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from AnnaBot.modules.helper_funcs.string_handling import split_quotes
from AnnaBot.modules.log_channel import loggable
from AnnaBot.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # AnnaBot's sticker
        keyboard = None
        log_reason = (
